...
admin.firestore().collection('payments').where('tenant_name', '==', 'praneeth').get().then(snap => { 
  snap.docs.forEach(d => console.log(d.id, d.data().month, d.data().status, d.data().amount, d.data().type)); 
  process.exit(0); 
