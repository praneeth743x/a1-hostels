      ...
      <div style={{ paddingBottom: '40px' }}>
        ...
        <div className={styles.analyticsGrid}>
          ...
          <div className={styles.glassCard}>
            ...
            <div className={styles.revenueAmount}>₹{filteredKpi.collected.toLocaleString('en-IN')}</div>
          ...
          <div className={styles.glassCard}>
            ...
            <div className={styles.revenueAmount} style={{ color: '#ef4444' }}>₹{filteredKpi.overdue.toLocaleString('en-IN')}</div>
